  ...
  return function() {
    var t, e, n = {
          ...
          7368: function(t, e) {
            ...
            e.Z = t => t ? t.replace(n, "$1cdn.flippenterprise.net") : ""
          },
          539: function(t, e, n) {
            "use strict";
    ...
    }, r.j = 975, r.p = "https://s3.amazonaws.com/f.wishabi.ca/hosted2/core/build/befa6f521bad22162e64d680b93aae061bd92d56-stg/lib/",
        function() {
          var t = {
            975: 0,
            910: 0,
    ...
    return function() {
      ...
      class tr {
        constructor(t) {
          (0, Kt.Z)(this, "mainFrame", void 0), (0, Kt.Z)(this, "frames", void 0), (0, Kt.Z)(this, "landmarks", void 0), (0, Kt.Z)(this, "config", void 0), (0, Kt.Z)(this, "isMultiPanel", void 0), (0, Kt.Z)(this, "usingGA", void 0), (0, Kt.Z)(this, "canonicalLinkHref", null), (0, Kt.Z)(this, "reset", (() => {
            this.frames = new Map, this.landmarks = new Map, this.removePrimaryListeners(), Ne.Z.reset(), jn.reset(), pn.reset();
            const t = {
          ...
          })), (0, Kt.Z)(this, "removePrimaryListeners", (() => {
            window.removeEventListener("message", this.onMessage), cn.default.removeEventListener(cn.ItemInteraction.ITEM_SELECTED, this.onItemSelected), cn.default.removeEventListener(cn.ItemInteraction.UNBOUND_ITEM_SELECTED, this.onUnboundItemSelected), cn.default.removeEventListener(cn.ItemInteraction.NO_PRODUCTS_HANDLED, this.onNoProducts), gi.ZP.removeEventListener(gi.jd.MULTI_ITEM_SELECTED, this.onMultiItemSelected), Di.removeEventListener(yi.NAVIGATE_TO_SHOPPING_LIST_REQUEST, this.onNavigateToShoppingList)
      ...
      const mr = () => null,
          ...
          Ir = {
            ...
            autoFlyer: "true",
            baseUrl: "https://s3.amazonaws.com/f.wishabi.ca/hosted2/core/build/befa6f521bad22162e64d680b93aae061bd92d56-stg",
            configUrl: "https://aq.flippenterprise.net/{{merchant}}/config.json",
            coreUrl: "https://cdn.flippenterprise.net/hosted2/core",
            // configUrl: "/core/customConfig/{{merchant}}.json",
            // coreUrl: "/core",
            locale: sr.Lh.en_US,
      ...
      class vr {
        ...
        ! function(t) {
          ...
          release: "befa6f521bad22162e64d680b93aae061bd92d56",
          sampleRate: .1
        })
      }(!1), setTimeout((async () => {
